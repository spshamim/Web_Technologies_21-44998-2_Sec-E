<?php
    ...
    function empsignup($form_data){
        ...
        $sql2 = "INSERT INTO employee (userID,empname, compname, contactno, username, password)
        VALUES ($lastID,'$empname', '$compname', '$contact', '$uname','$pass');";
