<?php
    ...
    if (
        ...
        !isset($_SESSION['desc_err'])
            ...
            $status = insertjob($id,$name,$data);
            if($status){
                $_SESSION['jb1']="Job Posted Successfully...!";
                header("location: ../../view/comp_after_login/company_dash.php");
            }else{
                $_SESSION["jb2"] = "database error occurred..!";
                header("location: ../../view/comp_after_login/emppostjob.php");
            }
        } else{
            header("location: ../../view/comp_after_login/emppostjob.php");
        }
