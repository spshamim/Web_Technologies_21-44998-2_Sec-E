<html>
    <head>
        ...
        ?>
        <link rel="stylesheet" href="../asset/css/view_jobs_admin.css">
        <script src="../js/adminjobsearch.js"></script>
    </head>
    <body>
                ...
                <td>
                    <div id="dd1">
                        <table width="1000px">
                                ...
                                <tr>
                                    <td>
                                        <legend id="cc2">Catagory</legend><br>
                                ...
                                <tr>
                                    <td colspan="7" align="center" id="rr002">
                                        <input class="styled" type="submit" value="Search" onclick="yy()">
                                    </td>
                                </tr>
                        </table>
                    </div>
