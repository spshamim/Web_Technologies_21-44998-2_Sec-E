                ...
                <td width="50%" align="center">
                    ...
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td style="display: flex;"><input type="text" width="100%" name="uname" style="font-size:20px; flex: 1;"></td>
                        </tr>
                        <tr>
                            <td></td>
                        ...
                        <tr>
                            <td></td>
                            <td align="right" ><br><input type="submit" name="login" value="Login" style="font-size: 20px; background-color: green; color: white; padding: 10px 20px; border: none; border-radius: 5px; cursor: pointer;"></td>
                        </tr>
                    </table>
                    </div>
                    </form>
