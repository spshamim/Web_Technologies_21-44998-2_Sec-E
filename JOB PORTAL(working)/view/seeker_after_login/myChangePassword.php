    ...
    <body>
        <div style="display: flex;">
            ...
            <div style="background: #39A7FF; margin-top: 60px; margin-left: 05px; width: 600px; height: 270px;">
                <label style="margin-left:20px; color:red; font-weight:bold"><?php echo isset($_SESSION['nandconf']) ? $_SESSION['nandconf'] : ''; ?></label>
                <label style="margin-left:150px; color:red; font-weight:bold"><?php echo isset($_SESSION['yessss']) ? $_SESSION['yessss'] : ''; ?></label>
                <label style="margin-left:20px; color:red; font-weight:bold"><?php echo isset($_SESSION['curnotmatch']) ? $_SESSION['curnotmatch'] : ''; ?></label>
                <div style="margin-top: 20px; margin-left: 20px;">
                    <form action="../../controller/myChangePasswordControl.php" method="post">
                        <table>
                            <tr>
...
unset($_SESSION['nandconf']);
unset($_SESSION['yessss']);
unset($_SESSION['curnotmatch']);
